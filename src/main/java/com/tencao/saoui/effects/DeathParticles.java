...
public class DeathParticles extends EntityFX {
    ...
    private void renderQueued(Tessellator tessellator){
        ...
        GLCore.addVertexColor(this.particleRed * colorIntensity, this.particleGreen * colorIntensity, this.particleBlue * colorIntensity, 1.0F);
        ...
        if (a < Math.PI) {
            GLCore.addVertex(xPos + x1 * cos, yPos + y1, zPos + z1 * sin, 0D, 1D);
            GLCore.addVertex(xPos + x2 * cos, yPos + y2, zPos + z2 * sin, 1D, 1D);
            GLCore.addVertex(xPos + x3 * cos, yPos + y3, zPos + z3 * sin, 1D, 0D);
            GLCore.addVertex(xPos + x4 * cos, yPos + y4, zPos + z4 * sin, 0D, 0D);
        } else {
            GLCore.addVertex(xPos - x1 * cos, yPos + y1, zPos - z1 * sin, 0D, 0D);
            GLCore.addVertex(xPos - x2 * cos, yPos + y2, zPos - z2 * sin, 1D, 0D);
            GLCore.addVertex(xPos - x3 * cos, yPos + y3, zPos - z3 * sin, 1D, 1D);
            GLCore.addVertex(xPos - x4 * cos, yPos + y4, zPos - z4 * sin, 0D, 1D);
        }
    }
