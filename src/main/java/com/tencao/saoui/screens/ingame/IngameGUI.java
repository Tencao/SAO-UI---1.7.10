...
public class IngameGUI extends GuiIngameForge {
    ...
    protected void renderHUDText(int width, int height)
    {
        ...
        if (OptionCore.DEFAULT_UI.getValue() || OptionCore.DEFAULT_DEBUG.getValue()) super.renderHUDText(width, height);
        else {
            ...
            if (!MinecraftForge.EVENT_BUS.post(event)) {
                ...
                for (String msg : right) {
                    ...
                    int leftL = width - (OptionCore.ALT_HOTBAR.getValue() || top < slotsY - fontRenderer.FONT_HEIGHT - 2 ? 2 : 26) - w;
